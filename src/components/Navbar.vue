<template>
  <header class="fixed w-[100vw] bg-stone-200" style="z-index: 100">
      ...
      >
        ...
        >
          ...
          <transition>
            <div v-if="showSearch">
              <div
                class=" w-[100vw] h-[113px] top-0 left-0 flex justify-center items-center gap-[15px] fixed bg-stone-200"
                style="z-index: 500"
              >
                <input
                  type="search"
    ...
    >
      ...
      <transition>
        <div  v-if="showSearch"  >
        <div class="w-full h-[113px] top-0 left-0 bg- flex justify-center items-center gap-[15px] fixed px-[3vw] bg-stone-200"
        style="z-index: 500;">
          ...
          <button class="w-[50px] h-[50px] bg-black"  
           @click="toSearchPage()">
            ...
            <img src="../assets/images/right-arrow.png" class="w-[30px] h-[30px]">
          </button>
        </div>
